...
namespace _420_476.Devoir3.Samuel.Octeau.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual int ADDUSER(string firstName, string lastName, string login, string password)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ADDUSER", firstNameParameter, lastNameParameter, loginParameter, passwordParameter);
        }
    
        public virtual ObjectResult<Nullable<int>> verifyUserIdentity(string login, string password)
        {
            var loginParameter = login != null ?
                new ObjectParameter("login", login) :
                new ObjectParameter("login", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("verifyUserIdentity", loginParameter, passwordParameter);
        }
    }
}
